...
TRACKING_SMALL_PORE_VOLUME_VOXELS = 64.0
TRACKING_SOFT_GATE_MIN_INTERSECTION_VOXELS = 3
TRACKING_SOFT_GATE_COST_PENALTY = 0.08
TRACKING_NOVEL_MIN_VOLUME_VOXELS = 8.0
TRACKING_NOVEL_MIN_PERSISTENCE = 2
